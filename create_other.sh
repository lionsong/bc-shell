...
while :
do
    IN=`snmpwalk -coffice -v2c 192.168.100.14 IF-MIB::ifInOctets.10102|awk '{print $NF}'`
    OUT=`snmpwalk -coffice -v2c 192.168.100.14 IF-MIB::ifOutOctets.10102|awk '{print $NF}'`
